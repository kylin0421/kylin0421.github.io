...
- 1. **Most works are incremental or even worse, combinatory.** Of course, incremental improvements and combination could still result in some meaningful works. However the cost-effectiveness ratio is significantly lower than in a less over-competitive and publication-oriented community.  
- 2. **Ideas will collide, even if you haven't found one yet.** This happened to me. It's not hard to see why since the community is crowded.
- 3. **Propagation of publication-oriented culture.** If most of your collegues are chasing paper counts instead of quality, unless you've already had 10k citations, it would be hard not to join them.
- ...
